export const bulgurSalad = {
  ...
  star: false,
  introText:
    'Known in Turkey as Kısır, this refreshing bulgur salad is packed with fresh vegetables, herbs, and sour notes, making it perfect as a side dish or a light main course.',
  description:
  ...
  ingredients: [
    ...
    },
    {
      ...
      amount: 0.5,
      unit: 'cup',
      flex: 'Any herb you like, such as dill, mint, or cilantro. Or all of them together!',
      optional: true,
      topping: false,
      done: false,
    },
