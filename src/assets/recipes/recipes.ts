export const Recipes = [
  ...
  //  Pesto
  {
    ...
    star: false,
    introText:
      'A versatile and flavorful sauce made from fresh basil or sundried tomatoes, perfect for pasta, sandwiches, and more.',
    description:
      'This pesto recipe is a delicious and easy-to-make sauce that can be used in a variety of dishes. It features fresh basil, nuts, and nutritional yeast for a rich, cheesy flavor without the dairy. Customize it with sundried tomatoes for a different twist!',
    tags: {
      quick: true,
      easy: true,
      temperature: '',
    ...
    ingredients: [
      {
        ...
        amount: 2,
        unit: 'cups',
        flex: 'Substitute with half a jar of sundried tomatoes for a tapenade instead',
        optional: false,
        topping: false,
        done: false,
      },
