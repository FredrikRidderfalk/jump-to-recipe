    ...
    flex: [
      {
        ...
        substitutes:
          'The bell pepper, corn, jackfruit, cilantro, and toppings can be substituted with anything. You can add more vegetables, but also add fewer vegetables than what we listed.',
      },
      {
        ingredient: 'Beans',
        substitutes: 'Kidney beans, great white beans, black beans, anything goes!',
      },
      {
        ingredient: 'MSG',
        substitutes: 'Not necessary, but a flavor enhancer.',
      },
      {
        ingredient: 'Chili flakes',
        substitutes:
          'Or fresh chopped up chili if we have it. We often add a hot sauce instead, or a chili paste like Tobanjjan or tabasco.',
      },
      {
        ingredient: 'Tortilla chips',
        substitutes:
          "This is added for crunch, so any chips fit. For example, we also love adding salt & vinegar chips, onion chips, BBQ chips, or if we don't have chips we may even go with roasted onion.",
      },
      {
        ingredient: 'Lime',
        substitutes: "Use lime, lemon, or yuzu, or we can use any vinegar in half the amount if we don't have citrus.",
      },
      {
        ingredient: 'Puréed tomatoes',
        substitutes: 'We can use canned crushed tomatoes instead, or even chop up fresh tomatoes ourselves.',
      },
    ],
    instructions: [
